 ...
 * ImageMedia
 *
 * Images are stored in `public/media/` and Payload stores their URL as
 * `/media/filename.png`. getMediaUrl() returns this relative path as-is,
 * which Next.js `<Image>` serves and optimizes natively — no `remotePatterns`
 * or absolute URLs needed for local media.
 */
